...
const statusColors = {
  ...
  in_progress: 'border-indigo-500 bg-indigo-50 dark:bg-indigo-950',
  scheduled: 'border-border bg-background',
}
                ...
                <div className="flex items-center gap-2">
                  <div
                    className={cn(
                      ...
                      projectTypeColors[block.projectType as keyof typeof projectTypeColors]
                    )}
                  />
