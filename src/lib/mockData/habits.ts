...
export const mockHabits: Habit[] = [
  ...
  },
  {
    ...
    tracking: {
      ...
      history: generateWeeklyHabitHistory(8, 0.80)
    },
    reminders: [
      {
        id: 'reminder-3',
  ...
  },
  {
    ...
    tracking: {
      ...
      history: generateWeeklyHabitHistory(8, 0.70)
    },
    reminders: [
      {
        id: 'reminder-7',
  ...
  },
  {
    ...
    tracking: {
      ...
      history: generateHabitHistory(30, 0.60, 'count_based')
    },
    reminders: [],
    createdAt: new Date('2025-04-15'),
    isActive: true
...
function generateWeeklyHabitHistory(
  weeks: number,
  successRate: number
): HabitRecord[] {
  const history: HabitRecord[] = []
...
export function getTodaysPendingHabits(): Habit[] {
  return mockHabits.filter(
    habit => habit.isActive && habit.tracking.todayStatus === 'pending'
  )
}
